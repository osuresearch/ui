...
export const LargeContent = RUIComponentStory<ConfirmButtonProps>((args) => (
  <ConfirmButton
    {...args}
    onPrimaryAction={() => alert('Thank you!')}
    onCancel={() => alert('Please leave!')}
