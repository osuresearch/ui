...
import { Prose as Component, ProseProps } from './Prose';
...
// NOTE: This sample comes from Tailwind's typography demo site so some language
// may not make sense when embedded here: https://tailwindcss.com/docs/typography-plugin
export const Prose = RUIComponentStory<ProseProps>(() => (
  <Component>
    <h1>The Prose Component</h1>
    ...
    <p>For more information about how to use the plugin and the features it includes, <ExternalLink href="https://github.com/tailwindcss/typography/blob/master/README.md">read the documentation</ExternalLink>.</p>

    <h2>Usage within Research UI</h2>
    <p>
      We provide a <code>Prose</code> component to apply a custom theme that matches our
      other dedicated RUI components.
    </p>
    <p>
      Components that utilize our <strong>Style System</strong> will disable prose styling,
      allowing you to embed RUI components like this <Button as="a" href="https://research.osu.edu">Button polymorphed to an anchor</Button> without
      worrying about style conflicts.
    </p>
    <hr />
