...
import { bgc, cx, ff, fs, fw, tc } from '~/theme/utils';
import {
  ColorProp,
  DefaultProps,
  ResponsiveProp,
...
export const _Box = forwardRef<HTMLElement, BoxProps & { component: React.ElementType }>(
 ...
 *
 * @deprecated - Replace with AltBox (and eventually rename AltBox to Box)
 */
export const LegacyBox = createPolymorphicComponent<'div', BoxProps>(_Box);
