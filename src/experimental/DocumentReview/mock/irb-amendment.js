    ...
    <div id="internationalstuff" data-comment-section="International Research Sites" data-comment-section-level="1">
        <div data-role="header" data-theme="f" class="grouping-header">
                ...
                <fieldset class="full-format ui-required" name="summaryBackgroundSupport" id="fieldset-summary-background-support">
                    ...
                    <div class="full-format text-output ui-input-search" name="summaryBackgroundSupport" id="summary-background-support" data-comment-inline="true">This project emerges within an existing body of work on fan pilgrimage and tourism, most of which focuses on how fans experience spaces depicted on screen or in writing. Important work in this field has been done by Will Brooker (2007a, 2007b) on Blade Runner and The X-Files; Jennifer Porter (2004) on Star Trek conventions; Derek Alderman (2002) on Graceland; Nick Couldry (2000) on EastEnders, and Stijn Reijnders (2010, 2011) on detective television. These works stress the multiplicity of places at filming locations and the traces fans leave at them, occasionally incorporating ethnographic material. None of these authors, however, address fan pilgrimage as a religious phenomenon, or draw on significant studies of religious pilgrimage (Turner 1974; Eade and Sallnow 1991; Margry 2008; Plate 2009). My past work on “Sherlock” fan pilgrimage (forthcoming in the Journal of Fandom Studies as "Constructing the Fannish Place: Ritual and Sacred Space in a Sherlock Fan Pilgrimage") enters this gap, arguing that fan pilgrimage places are genuinely sacred spaces, ritually co-created by fans. The present project follows that previous paper, addressing a specific absence I encountered. In the course of my research, I discovered a general lack of attention to how fans articulate and narrativize the relationship between their pilgrimages and the texts on which those visits are based. This absence includes most of the works cited above. While it is feasible to examine the ritual creation of fannish sacred spaces based on visible traces, ultimately such a study can only characterize these "containers," rather than the beliefs and discourses that fans bring to them. Without consideration of such discourses, understandings of how pilgrims understand pilgrimages are speculative. This study, therefore, seeks to collect a small sample of fans' pilgrimage rationales and stories, with the goal of enabling more nuanced study.
                    </div>
                </fieldset>
            </div><div data-role="content" class="content-group">
