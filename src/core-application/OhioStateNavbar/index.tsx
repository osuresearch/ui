...
const OhioStateNavbar = () => (
  <nav className="osu-navbar" aria-label="Ohio State nav bar">
    ...
    <div className="osu-navbar-links">
      <ul>
        <li>
          <a href="https://www.osu.edu/help.php" className="osu-navbar-help">
            Help
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="https://www.osu.edu/map/" className="osu-navbar-map">
            Map
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="https://email.osu.edu/" className="osu-navbar-webmail">
            Webmail
          </a>
        </li>
        <li>
          <a href="https://www.osu.edu/search/" className="osu-navbar-search">
            Search Ohio State
          </a>
        </li>
      </ul>
