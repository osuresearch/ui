...
* **a11y:** `Text.Rich` no longer uses h1-h3 DOM elements to avoid conflicts with existing page layout (resolves [#17](https://github.com/osuresearch/ui/issues/17)) ([c7aaf87](https://github.com/osuresearch/ui/commit/c7aaf871ea3c8d3076f0ced6eac0568dec5c581e))
* **a11y:** link themed buttons will now correctly show a focus ring (resolves [#20](https://github.com/osuresearch/ui/issues/20)) ([0c2e9fa](https://github.com/osuresearch/ui/commit/0c2e9fa888b7b6c22541311bbf52babf3b241390))
* Add `name` and `id` props to Text.Rich component (resolves FWK-375 and FWK-377) ([d764f13](https://github.com/osuresearch/ui/commit/d764f1341728412e1381259348fcbcdd74d47660))
* Added icons to invalid and valid form feedback text so they can pass WCAG 1.4.1 ([8763d2a](https://github.com/osuresearch/ui/commit/8763d2a2a72c18d8884d763f9ef407dc8eb5cd25))
* Alert close button position style ([e4636f3](https://github.com/osuresearch/ui/commit/e4636f380b8e46896e98ce29574c6c1d27ec7627))
* ARIA issue with Alert - allow users to choose the role, since role='alert' should be used sparingly and is rather inaccessible if not used properly. Keeping the default role as alert to prevent a breaking change. ([4873183](https://github.com/osuresearch/ui/commit/48731839d65a3b929b750d9de0a9b1e4f1053ae6))
* Change default Alert role to status ([8441a69](https://github.com/osuresearch/ui/commit/8441a698e5341d554115b9b3b2bd83964e533ab1))
* ChangeParams and ChangeTargetOptions missing from exports (resolves [#8](https://github.com/osuresearch/ui/issues/8)) ([67f62fc](https://github.com/osuresearch/ui/commit/67f62fc7307d3e79a65673f80bbee37195a98c0f))
* className gnored on all top level form components (resolves FWK-373) ([5df45b4](https://github.com/osuresearch/ui/commit/5df45b439e0985164219886dbffcb3899aa49988))
* Correct documentation for adding accessible text to an `<Icon>` ([23e6c94](https://github.com/osuresearch/ui/commit/23e6c94e156218c03a421942a44b8a2352ce9c16))
* dangerouslySetInnerHTML for Checkbox and Radio labels (resolves FWK-374) ([81814bf](https://github.com/osuresearch/ui/commit/81814bf8003cd02d943fcc4a18d6cc5b56793586))
* division symbol deprecation warnings in sass files ([7364811](https://github.com/osuresearch/ui/commit/73648114187677e1b5d4e79f72514e8a7f090301))
* FeldSet does not use `id` attribute (resolves FWK-365) ([1b68d26](https://github.com/osuresearch/ui/commit/1b68d2610682a720c15cc91bb9f16055940c9d32))
* Give `Navbar` a unique label (resolves FWK-401) ([bc3aae6](https://github.com/osuresearch/ui/commit/bc3aae6ba0dc14c7d76dbcf753e877af3521a45c))
* Handle Dropdown.readOnly and MultiSelect.readOnly props (resolves FWK-378) ([eea9f50](https://github.com/osuresearch/ui/commit/eea9f506f2e8152d9511125340866d0085fc9981))
* incorrect export of `SearchFilters` as a type (resolves FWK-384) ([418655e](https://github.com/osuresearch/ui/commit/418655e0f15f4e0e4a947d3422d5a685a26be488))
* Increase contrast ratio between navigation item and NavBar (resolves FWK-399) ([e24ad8d](https://github.com/osuresearch/ui/commit/e24ad8d090b6f6a3abf452315a99d4c71bd4230a))
* invalid import paths to JsonObject ([5c5b52b](https://github.com/osuresearch/ui/commit/5c5b52bbf63290806089fd6bb1b723265060f5be))
* Labels do not support HTML content (resolves FWK-374) ([f670f9c](https://github.com/osuresearch/ui/commit/f670f9c51e27167124a73a8cb0925f7bbd92bbc3))
* LazyLoaded content now displays as soon as loading is complete without delay. Screen reader enhancements no longer affect visual display ([cc1de76](https://github.com/osuresearch/ui/commit/cc1de76cecad7f11faa136ac2fb8d732f5279c34))
* LazyLoaded display logic where toggling back to loading would not show the placeholder ([b814f9a](https://github.com/osuresearch/ui/commit/b814f9a5f989e9706ad18b3cb23db71fbf8e322f))
* missing search drivers and interfaces to package export (resolves FWK-385) ([8ae10e9](https://github.com/osuresearch/ui/commit/8ae10e9a8b8a19a2a2c1f13d0ca8a7b07f699968))
* missing type information for DropOverlay.Menu props ([80707ce](https://github.com/osuresearch/ui/commit/80707cef4a536c1c1fdd9b2028860f73b990fa30))
* Properly handle onBlur for DateTime component (partially resolves FWK-379) ([974596e](https://github.com/osuresearch/ui/commit/974596e12e852ee3c12821740f6e3ab48c1b2471))
* Remove experimental `AppSearch` and `DocumentReview` components ([6e39829](https://github.com/osuresearch/ui/commit/6e398292ba03cfd747b1d59f37adbd720dcfadb8))
* remove package-level exports of search drivers introduced in 4.4.10 ([c047162](https://github.com/osuresearch/ui/commit/c0471625c4f0b0914c3dfb1b582310759ec82f81))
* Resolve CSS validation errors, excluding SVG false positive errors (resolves FWK-400) ([f730ff5](https://github.com/osuresearch/ui/commit/f730ff580f6c1c4212ffe04fa027db2cd96c8ea3))
* Set document title to Page title prop every time that prop changes ([3d7aacb](https://github.com/osuresearch/ui/commit/3d7aacbcf4b26822ecf78d3843eff6fe602779fa))
* Show asterisk for required single checkboxes (resolves FWK-376) ([f856c5a](https://github.com/osuresearch/ui/commit/f856c5a356a057789d56879248f55e957c3d0717))
* **styleguide:** add a .htaccess so deployed styleguides can be accessed from just the project root ([7b6c3f2](https://github.com/osuresearch/ui/commit/7b6c3f25cbfb1e3f64d7cde72b84c99d78007f17))
* Update FieldSet to not require a `name` and to inherit the `id` as the `name` if no name is set (follows the pattern of the rest of the components) ([bb6ce81](https://github.com/osuresearch/ui/commit/bb6ce81185acac6854ef026be1b1426415cf843a))
* Update type of children prop for <FieldSet.Legend> to ReactChild, allowing both JSX elements and strings ([9b808b8](https://github.com/osuresearch/ui/commit/9b808b8f863caa82d4be6ec1b4abb6c6edff94fe))
* Use state to control the visibility of Alerts, instead of the Bootstrap data-dismiss attribute (resolves FWK-383) ([3f3c9ed](https://github.com/osuresearch/ui/commit/3f3c9edf310722dfa6c02ab60ad5ea5741b02010))


### Features

* Add `<Page>` component to improve application accessibility ([4fab2f8](https://github.com/osuresearch/ui/commit/4fab2f8cd735dbaf0623977129ba3452b0e038dd))
* add `Text.Autocomplete` component ([a531b03](https://github.com/osuresearch/ui/commit/a531b03a0c46ba9d8f9957cc9a5b89907b66ee8a))
* add optional `className` prop to `DropOverlay.Menu` and `DropOverlay.Menu.Item` ([d2b1217](https://github.com/osuresearch/ui/commit/d2b1217f72d4631632b66f7030fe8a800ca6b3fd))
* add optional placeholder prop to `Lookup.Input` ([06dedd5](https://github.com/osuresearch/ui/commit/06dedd5874b1ee9d4b11d9752b02b4083c803dbc))
* add Upload form component ([f11c819](https://github.com/osuresearch/ui/commit/f11c819dbc4aaf30ca933d4f6bae08f25ee252f3))
* CheckboxSet component for Checkbox fieldsets ([2c22118](https://github.com/osuresearch/ui/commit/2c2211858e4fac16eb33e08b14470d810ef5d2d3))
* LazyLoaded component for better lazy loaded content accessibility ([f2aa02b](https://github.com/osuresearch/ui/commit/f2aa02b9a7f4cc1ec1ed52d25afd22ceb428a7ad))
* RadioSet component for Radios in fieldsets ([3c41d3e](https://github.com/osuresearch/ui/commit/3c41d3eaf6288d650b41e65c97b8719e426850b7))
