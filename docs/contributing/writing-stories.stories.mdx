...
export default RUIComponentMeta<DemoProps>(
  ...
  .withBadge('beta')
  .withBadge('deprecated'); // Add one or more badges
...
// Add additional stories. Each one can take an optional
// third argument with markdown for the story description.
...
export const NotConfigurable = RUIComponentStory(() =>
  <Demo>
    not configurable!
  </Demo>
);
...
export const _NotVisible = RUIComponentStory(() =>
  <Demo>
    not visible!
  </Demo>
);
