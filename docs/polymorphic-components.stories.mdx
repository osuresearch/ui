...
Some of our components (Button, Text, etc) accept special `as` prop that lets you
...
export const Button = polymorphicForwardRef<ButtonProps>(({ as, children, ...props }, ref) => {
