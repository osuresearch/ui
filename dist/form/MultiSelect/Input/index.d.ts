...
declare type OptionGroupTemplateType = React.ReactNode | ((option: any, index: number) => React.ReactNode);
declare type ItemTemplateType = React.ReactNode | ((option: any) => React.ReactNode);
declare type SelectedItemTemplateType = React.ReactNode | ((value: any) => React.ReactNode);
declare type EmptyFilterMessageType = React.ReactNode | ((props: InputProps) => React.ReactNode);
...
declare type PanelHeaderTemplateType = React.ReactNode | ((e: PanelHeaderTemplateParams) => React.ReactNode);
declare type PanelFooterTemplateType = React.ReactNode | ((props: InputProps, hide: () => void) => React.ReactNode);
