...
exports.validateAndTransformJsonApiResponse = validateAndTransformJsonApiResponse;
...
function validateAndTransformJsonApiResponse(res) {
  if (!res.ok) {
    var message = 'Malformed API Response';
    ...
    } catch (e) {// Malformed response from the endpoint, a developer
